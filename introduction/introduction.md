...
If you want use a pre-deployed database sharding environment, working with the sharded database and scale the sharded database directly, you can use the workshop from this link: [Working with Oracle Shard Database](https://minqiaowang.github.io/oracle-sharded-database/work-with-db-shard/workshops/freetier).
