...
resource "oci_core_app_catalog_listing_resource_version_agreement" "generated_oci_core_app_catalog_listing_resource_version_agreement" {
	listing_id = "ocid1.appcataloglisting.oc1..aaaaaaaat4huq67kkankbm562nikng3wmeldn37wedrkhud44revbawpa56q"
	listing_resource_version = "Oracle_Database_19.14.0.0.220118_-_OL7U9"
}
...
resource "oci_core_instance" "cata_instance" {
  ...
  source_details {
    source_type = "image"
    source_id   = "ocid1.image.oc1..aaaaaaaavjiwpo37eityjjzzl23mhgi4qssg3atytmznfmf5xp3aphdtoa2q"
